...
from gf3d.plot.section_aligned import (
    plotsection_aligned_single,
    get_azimuth_distance_traveltime,
    filter_stations,
)
...
Pobs, Psyn = get_azimuth_distance_traveltime(
    cmt, pobs, psyn, comp="Z", traveltime_window=("P", windowP)
)

Sobs, Ssyn = get_azimuth_distance_traveltime(
    cmt, pobs, psyn, comp="Z", traveltime_window=("S", windowS)
)

for _obs, _syn in zip(Pobs, Psyn):
    _syn.stats.traveltime = _obs.stats.traveltime
    _syn.stats.label = _obs.stats.label

for _obs, _syn in zip(Sobs, Ssyn):
    _syn.stats.traveltime = _obs.stats.traveltime
    _syn.stats.label = _obs.stats.label
