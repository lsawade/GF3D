...
ax.axis("off")
plot_label(ax, "GF  ", location=0, box=False, fontsize=44, color=DARKGRAY, zorder=10)
plot_label(ax, "  3 ", location=0, box=False, fontsize=44, color=ORANGE, zorder=10)
plot_label(ax, "   D", location=0, box=False, fontsize=44, color=DARKGRAY, zorder=10)
